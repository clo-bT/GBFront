            ...
            <div className={styles.contentDetail}>
              ...
              <div className={styles.detailInfoGrid}>
                {!roomoption.airConditioner ? (
                  <>
                    <div className={styles.detailInfoGridItem}>
                      <img src={`${process.env.PUBLIC_URL}/assets/roomoption/airConditioner.png`} />
                      <h3>에어컨</h3>
                    </div>
                  </>
                ) : null}
                {!roomoption.refrigerator ? (
                  <>
                    <div className={styles.detailInfoGridItem}>
                      <img src={`${process.env.PUBLIC_URL}/assets/roomoption/refrigerator.png`} />
                      <h3>냉장고</h3>
                    </div>
                  </>
                ) : null}
                {!roomoption.washer ? (
                  <>
                    <div className={styles.detailInfoGridItem}>
                      <img src={`${process.env.PUBLIC_URL}/assets/roomoption/washer.png`} />
                      <h3>세탁기</h3>
                    </div>
                  </>
                ) : null}
                {!roomoption.dryer ? (
                  <>
                    <div className={styles.detailInfoGridItem}>
                      <img src={`${process.env.PUBLIC_URL}/assets/roomoption/dryer.png`} />
                      <h3>건조기</h3>
                    </div>
                  </>
                ) : null}
                {!roomoption.sink ? (
                  <>
                    <div className={styles.detailInfoGridItem}>
                      <img src={`${process.env.PUBLIC_URL}/assets/roomoption/sink.png`} />
                      <h3>싱크대</h3>
                    </div>
                  </>
                ) : null}
                {!roomoption.gasRange ? (
                  <>
                    <div className={styles.detailInfoGridItem}>
                      <img src={`${process.env.PUBLIC_URL}/assets/roomoption/gasRange.png`} />
                      <h3>가스레인지</h3>
                    </div>
                  </>
                ) : null}
                {!roomoption.closet ? (
                  <>
                    <div className={styles.detailInfoGridItem}>
                      <img src={`${process.env.PUBLIC_URL}/assets/roomoption/closet.png`} />
                      <h3>옷장</h3>
                    </div>
                  </>
                ) : null}
                {!roomoption.shoeCloset ? (
                  <>
                    <div className={styles.detailInfoGridItem}>
                      <img src={`${process.env.PUBLIC_URL}/assets/roomoption/shoeCloset.png`} />
                      <h3>신발장</h3>
                    </div>
                  </>
                ) : null}
                {!roomoption.fireAlarm ? (
                  <>
                    <div className={styles.detailInfoGridItem}>
                      <img src={`${process.env.PUBLIC_URL}/assets/roomoption/fireAlarm.png`} />
                      <h3>화재경보기</h3>
                    </div>
                  </>
                ) : null}
                {!roomoption.elevator ? (
                  <>
                    <div className={styles.detailInfoGridItem}>
                      <img src={`${process.env.PUBLIC_URL}/assets/roomoption/elevator.png`} />
                      <h3>엘레베이터</h3>
                    </div>
                  </>
                ) : null}
          ...
          <div className={styles.contentTab}>
            ...
            <div className={styles.fixedTab}>
              ...
              <div className={styles.fixedInfo}>
                {" "}
                {/* 상위 탭 */}
                <div className={styles.fixedTopInfoLeft}>
                  {" "}
                  {/* 왼쪽 */}
              ...
              <div className={styles.fixedInfoBottomTab}>
                ...
                <button onClick={handleStar}>찜</button>
                {/* 중앙 배치 - 가로 세로 둘 다 */}
              </div>
            </div>
          </div>
